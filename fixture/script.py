...
table_dfs = [
    ...
    (dict_entities_main, "dict_entities", None),
    (intakes, "intakes", {"multi": True}),
    (aquifers, "aquifer_codes", {"base": False}),
    (chem, "chem_codes", {"base": False}),
    (fields, "fields", {"multi": True}),
    (wells, "wells", None),
    (aquifer_well, "wells_aquifer_usage", None),
    (wells_aquifers, "wells_aquifers", None),
    (wells_regime, "wells_regime", None),
    (wells_water, "wells_water_depth", None),
    (wells_sample_tab, "wells_sample", None),
    (wells_chem_tab, "wells_chem", None),
